...
typedef struct
{
	...
	ECADrvrCalls_t  *pDrvrCalls; /**< specific driver routines for framing commands and reading/writing commands. */
	void			*pDrvrParams; /**< reference to any specific driver information needed to execute a read/write */
